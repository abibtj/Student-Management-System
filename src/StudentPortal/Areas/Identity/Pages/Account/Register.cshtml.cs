            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    catch (System.Net.Http.HttpRequestException ex) // email confirmation message not sent, remove user
                    {
                        ...
                        _logger.LogError("Error, {Name}", ex.ToString());
                        ModelState.AddModelError(string.Empty, "An error occured while sending email confirmation link. Please, check your internet connection and try again.");
                    ...
                    else
                    {
                        ...
                        return LocalRedirect(returnUrl); // Everything went on smoothly.
                    }
                }
